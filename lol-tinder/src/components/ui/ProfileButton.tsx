...
export function ProfileButton({ user, className = "", children }: ProfileButtonProps) {
  if (!user) return null;
...
export function ViewProfileButton({ profileId, className = "", children }: { profileId: string, className?: string, children?: React.ReactNode }) {
  return (
